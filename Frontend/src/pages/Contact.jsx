  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-emerald-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
                <h2 className="text-3xl font-bold text-slate-800 mb-8">{t('contact.getInTouch')}</h2>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-slate-800 mb-1">{t('contact.addressTitle')}</h3>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-slate-800 mb-1">{t('contact.phoneTitle')}</h3>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-slate-800 mb-1">{t('contact.emailTitle')}</h3>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-slate-800 mb-1">{t('contact.hoursTitle')}</h3>
              ...
              <div className="bg-gradient-to-br from-emerald-100 to-slate-100 rounded-2xl p-8 shadow-xl border border-white/20">
                <h3 className="text-2xl font-bold text-slate-800 mb-4">{t('contact.quickHelpTitle')}</h3>
                <p className="text-slate-600 mb-6">
                  {t('contact.quickHelpText')}
                </p>
            ...
            {/* Contact Form */}
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
              <h2 className="text-3xl font-bold text-slate-800 mb-8">{t('contact.sendMessageTitle')}</h2>
              {submitStatus === 'success' && (
                <div className="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-emerald-800 font-medium">{t('contact.successMessage')}</p>
                  </div>
                </div>
              )}
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
            <h2 className="text-3xl font-bold text-slate-800 mb-8 text-center">{t('contact.mapTitle')}</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                {import.meta.env.VITE_MAPBOX_ACCESS_TOKEN && (
                  ...
                  >
                    {useSimpleMap ? t('contact.useInteractiveMap') : t('contact.useSimpleMap')}
                  </button>
                )}
                <a
