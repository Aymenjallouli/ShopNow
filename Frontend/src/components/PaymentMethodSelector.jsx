...
const PaymentMethodSelector = ({ onSuccess, amount, orderData }) => {
  ...
  return (
    <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6">
      <h2 className="text-2xl font-bold text-slate-800 mb-6">Choose Payment Method</h2>
          ...
          <label htmlFor="stripe" className="ml-3 flex items-center cursor-pointer">
            <div className="flex items-center">
              ...
              <div>
                ...
                <div className="text-sm text-slate-500">Visa, Mastercard, etc.</div>
              </div>
            </div>
          </label>
        </div>
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="d17" className="ml-3 flex items-center cursor-pointer">
              <div className="flex items-center">
                ...
                <div>
                  <div className="font-medium text-slate-800">d17 Mobile Payment</div>
                  <div className="text-sm text-slate-500">Paiement mobile tunisien</div>
                </div>
              </div>
            </label>
          </div>
      ...
      {selectedMethod === 'stripe' && (
        <div>
          <h3 className="text-lg font-semibold text-slate-800 mb-4">Card Payment</h3>
          
          {/* Affichage du montant */}
          <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-lg p-4 mb-4">
            <div className="flex justify-between items-center">
              <span className="text-slate-600 dark:text-slate-300">Amount to pay:</span>
      ...
      {selectedMethod === 'd17' && (
        <div>
          <h3 className="text-lg font-semibold text-slate-800 mb-4">d17 Mobile Payment</h3>
          <D17Payment
            amount={amount}
            ...
            onError={(error) => {
              ...
              setError('Erreur lors du paiement d17');
            }}
          />
        </div>
      )}
