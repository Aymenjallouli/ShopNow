        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-xs leading-5 text-gray-500">
              &copy; {currentYear} ShopNow, Inc. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0 flex space-x-6">
              <Link to="/privacy" className="text-xs leading-5 text-gray-500 hover:text-indigo-600">
                Privacy Policy
              </Link>
              <Link to="/terms" className="text-xs leading-5 text-gray-500 hover:text-indigo-600">
                Terms of Service
              </Link>
              <Link to="/cookies" className="text-xs leading-5 text-gray-500 hover:text-indigo-600">
                Cookie Policy
              </Link>
            </div>
          </div>
