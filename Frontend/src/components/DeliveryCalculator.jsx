...
const DeliveryCalculator = ({ shippingInfo, onDeliveryUpdate }) => {
  ...
  const calculateDelivery = useCallback(async () => {
    ...
    try {
      ...
      if (!zoneInfo) {
        setError('Gouvernorat non trouvé dans nos zones de livraison');
        setLoading(false);
        return;
      }
      ...
      const calculatedDelivery = {
        ...
        message: `Livraison disponible vers ${shippingInfo.city} - Zone ${zoneInfo.zone}`
      };
      ...
      setError('Erreur lors du calcul des frais de livraison');
    } finally {
      setLoading(false);
    }
  ...
  const getDeliveryStatus = () => {
    ...
    if (deliveryInfo) return 'Frais de livraison calculés';
    return 'Saisissez votre adresse pour calculer la livraison';
  };

  return (
    <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6">
      <h3 className="text-xl font-bold text-slate-800 mb-4 flex items-center">
        {getDeliveryIcon()} Informations de Livraison
      </h3>
      ...
      {deliveryInfo && (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-gradient-to-r from-emerald-50 to-green-50 p-4 rounded-xl border border-emerald-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-emerald-600">Frais de livraison</p>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-xl border border-purple-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-purple-600">Temps de livraison estimé</p>
          ...
          {deliveryInfo.delivery_zones && (
            <div className="mt-6">
              <h4 className="font-semibold text-slate-700 mb-3">Zones de livraison disponibles :</h4>
