        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div className="sm:max-w-lg">
            <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-6xl">
              Discover Amazing <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-cyan-600">Products</span>
            </h1>
            <p className="mt-4 text-xl text-slate-600 leading-relaxed">
              Shop with confidence from our curated collection of high-quality products. 
              Fast delivery, secure payments, and exceptional customer service guaranteed.
            </p>
            ...
            <div className="mt-10 grid grid-cols-3 gap-6 text-center">
              <div className="flex flex-col items-center group">
                ...
                <span className="text-sm font-semibold text-slate-700">Quality Assured</span>
                <span className="text-xs text-slate-500 mt-1">Premium products</span>
              </div>
              <div className="flex flex-col items-center group">
                ...
                <span className="text-xs text-slate-500 mt-1">2-day shipping</span>
              </div>
              <div className="flex flex-col items-center group">
                ...
                <span className="text-xs text-slate-500 mt-1">256-bit SSL</span>
              </div>
            </div>
          </div>
                ...
                <div className="relative h-80 w-72 overflow-hidden rounded-3xl bg-gradient-to-br from-white to-slate-50 sm:h-64 sm:w-96 lg:h-80 lg:w-80 shadow-2xl shadow-slate-200/50 border border-slate-200/50">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <h3 className="text-lg font-bold text-slate-800 mb-2">Premium Shopping</h3>
                      <p className="text-sm text-slate-600">Curated products for you</p>
                    </div>
                  </div>
