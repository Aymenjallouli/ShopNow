...
const Header = () => {
  ...
  const navigation = [
    { name: t('header.home'), key: 'home', href: '/', current: location.pathname === '/' },
    { name: t('header.products'), key: 'products', href: '/products', current: location.pathname === '/products' },
    { name: t('header.categories'), key: 'categories', href: '/categories', current: location.pathname === '/categories' },
    { name: t('header.deals'), key: 'deals', href: '/deals', current: location.pathname === '/deals' },
    { name: t('header.contact'), key: 'contact', href: '/contact', current: location.pathname === '/contact' },
  ];
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden lg:flex items-center">
              <div className="relative">
                <input
                  type="text"
                  placeholder={t('header.searchProductsPlaceholder')}
