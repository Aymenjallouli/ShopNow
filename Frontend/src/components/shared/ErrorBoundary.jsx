          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 max-w-lg w-full">
            <div className="text-center">
              ...
              <h1 className="text-2xl font-bold text-gray-800 mb-4">
                {t('errorBoundary.title', "Oops! Quelque chose s'est mal passé")}
              </h1>

              <p className="text-gray-600 mb-6">
                {t('errorBoundary.message', "Une erreur inattendue s'est produite. Veuillez actualiser la page ou réessayer plus tard.")}
              </p>
              ...
              <div className="space-y-3">
                ...
                >
                  {t('errorBoundary.refresh', 'Actualiser la page')}
                </button>
              ...
              {process.env.NODE_ENV === 'development' && this.state.error && (
                <details className="mt-6 text-left">
                  <summary className="cursor-pointer text-sm text-gray-500 hover:text-gray-700">
                    {t('errorBoundary.details', "Détails de l'erreur (dev)")}
                  </summary>
